...
<<<<<<< Updated upstream:Seleccion Natural/Resultados/Graficas.gd
	var font = load("res://Assets/Fronts/Xolonium-Bold.ttf")
=======
	var font = load("res://Assets/Fonts/Xolonium-Bold.ttf")
...
>>>>>>> Stashed changes:Seleccion Natural/Mundo/Puntuación/Graficas.gd
